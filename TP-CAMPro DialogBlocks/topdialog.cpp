...
#pragma implementation "topdialog.h"
#endif
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_TOPDIALOG_BUTTON in TopDialog.
    ...
    BasicControls* window = new BasicControls(this, ID_BASICCONTROLS, _("BasicControls"));
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_TOPDIALOG_BUTTON1 in TopDialog.
    // Before editing this code, remove the block markers.
    ComplexDialog* window = new ComplexDialog(this, ID_COMPLEXDIALOG, _("ComplexDialog"));
    int returnValue = window->ShowModal();
    window->Destroy();
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_TOPDIALOG_BUTTON2 in TopDialog.
    // Before editing this code, remove the block markers.
    AdvancedControls* window = new AdvancedControls(this, ID_ADVANCEDCONTROLS, _("AdvancedControls"));
    int returnValue = window->ShowModal();
    window->Destroy();
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_TOPDIALOG_BUTTON3 in TopDialog.
    // Before editing this code, remove the block markers.
    ScrollingDialog* window = new ScrollingDialog(this, ID_SCROLLINGDIALOG, _("ScrollingDialog"));
    int returnValue = window->ShowModal();
    window->Destroy();
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_TOPDIALOG_BUTTON4 in TopDialog.
    // Before editing this code, remove the block markers.
    WizardDialog* window = new WizardDialog(this, ID_WIZARDDIALOG);
    window->Run();
    window->Destroy();
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_TOPDIALOG_BUTTON5 in TopDialog.
    // Before editing this code, remove the block markers.
    SettingsDialog* window = new SettingsDialog(this, ID_SETTINGSDIALOG, _("SettingsDialog"));
    int returnValue = window->ShowModal();
    window->Destroy();
...
////@begin wxEVT_COMMAND_BUTTON_CLICKED event handler for ID_TOPDIALOG_BUTTON6 in TopDialog.
    // Before editing this code, remove the block markers.
    SplitterDialog* window = new SplitterDialog(this, ID_SPLITTERDIALOG, _("SplitterDialog"));
    int returnValue = window->ShowModal();
    window->Destroy();
